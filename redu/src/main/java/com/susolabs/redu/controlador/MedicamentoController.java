...
import com.susolabs.redu.modelo.facade.MedicamentoFacade;
...
public class MedicamentoController implements Serializable {
    ...
    @EJB
    private com.susolabs.redu.modelo.facade.MedicamentoFacade ejbFacade;
    private List<Medicamento> items = null;
    private Medicamento selected;
    private List<Medicamento> seleccion;

    public MedicamentoController() {
    }

    public List<Medicamento> getSeleccion() {
        return seleccion;
    }

    public void setSeleccion(List<Medicamento> seleccion) {
    ...
    public Medicamento getMedicamento(java.lang.Integer id) {
