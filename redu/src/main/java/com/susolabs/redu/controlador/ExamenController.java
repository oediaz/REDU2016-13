...
import com.susolabs.redu.modelo.facade.ExamenFacade;
...
public class ExamenController implements Serializable {
    ...
    @EJB
    private com.susolabs.redu.modelo.facade.ExamenFacade ejbFacade;
    private List<Examen> items = null;
    private Examen selected;
    private List<Examen> seleccion;

    public ExamenController() {
    }

    public List<Examen> getSeleccion() {
        return seleccion;
    }

    public void setSeleccion(List<Examen> seleccion) {
    ...
    public Examen getExamen(java.lang.Integer id) {
