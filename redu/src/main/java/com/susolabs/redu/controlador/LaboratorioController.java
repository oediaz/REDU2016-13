...
import com.susolabs.redu.modelo.facade.LaboratorioFacade;
...
public class LaboratorioController implements Serializable {
    ...
    @EJB
    private com.susolabs.redu.modelo.facade.LaboratorioFacade ejbFacade;
    private List<Laboratorio> items = null;
    private Laboratorio selected;
    private List<Laboratorio> seleccion;

    public LaboratorioController() {
    }

    public List<Laboratorio> getSeleccion() {
        return seleccion;
    }

    public void setSeleccion(List<Laboratorio> seleccion) {
