 ...
 */
@Stateless
public class TratamientocancermamaFacade extends AbstractFacade<Tratamientocancermama> {
    ...
    public TratamientocancermamaFacade() {
        super(Tratamientocancermama.class);
    }
