 ...
 */
@Stateless
public class ResultadosmamografiaepFacade extends AbstractFacade<Resultadosmamografiaep> {
    ...
    public ResultadosmamografiaepFacade() {
        super(Resultadosmamografiaep.class);
    }
